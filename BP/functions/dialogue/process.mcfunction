...
# Call sequence router to show text
function dialogue/routers/voices

# Call voice router to play sound
execute positioned as @s run function dialogue/routers/sequences