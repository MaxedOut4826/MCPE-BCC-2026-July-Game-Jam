execute as @e[type=happy_ghast] run function entities/properties/registry/happy_ghast_setup
execute as @e[type=arrow] run function entities/properties/registry/arrows
